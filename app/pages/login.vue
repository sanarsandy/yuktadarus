  ...
  <div class="min-h-screen bg-cream-100 flex flex-col items-center justify-center p-6 sm:p-10">
    <div class="w-full max-w-md animate-fade-up">
      ...
      <div class="text-center mb-10">
        <h1 class="text-3xl font-extrabold text-emerald-800 mb-2">Welcome Back</h1>
        <p class="text-cream-400">Sign in to continue your journey</p>
      </div>
      ...
      <p class="text-center mt-8 text-cream-400">
        ...
        <NuxtLink to="/register" class="text-emerald-600 font-bold hover:underline">
          Register
        </NuxtLink>
      </p>
    </div>
...
async function handleLogin() {
  ...
  try {
    ...
    // Error is handled in store and displayed via userStore.error if needed
    // But we can also show a toast here
    const { error } = useToast()
    error(userStore.error || 'Login failed')
  } finally {
